...
botonTutorial.addEventListener("click", ()=>{
    swal({
        title: "Modo Hardcore",
        text: "Simon sólo te dará el nuevo color que añade a la secuencia. ¡Tú deberás ir recordando y repitiendo los dados anteriormente!"
    })
});
